...
namespace Coach.API.Packages.GetHistoryPurchase
{
    public record GetHistroryPurchaseQuery(Guid UserId, int Page, int RecordPerPage, Boolean? IsExpiried, Boolean? IsOutOfUse) : IQuery<List<PurchaseRecord>>;
